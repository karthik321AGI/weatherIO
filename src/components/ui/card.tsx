...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg border border-white/20 bg-white/10 backdrop-blur-lg text-white",
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn(
      "text-sm text-white/70 dark:text-gray-300",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "border-t border-white/10 dark:border-gray-800",
      className
    )}
    {...props}
  />
